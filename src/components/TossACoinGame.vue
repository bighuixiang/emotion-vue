		...
		<div class="page-content text-center">
			...
			<div class="interaction">
				...
				<div class="interaction-btn">
					<img src="../../static/image/common/yingbizheng.png" @click="guess(1)" />
					<img src="../../static/image/common/yingbifan.png" @click="guess(2)" />
				</div>
			</div>
	...
	export default {
		...
		methods: {
			guess(num) {
				...
				self.$http.post(self.API.coin, data).then(response => {
